...
Как искать шаблон: получить полный список и отфильтровать по name на стороне клиента. Если шаблон уже использован в другом RFQ,
он не попадёт в список — тогда нужен новый шаблон (копия в ЛК) или привязка через rfq_id уже созданной процедуры.
